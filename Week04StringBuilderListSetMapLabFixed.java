...
public class Week04StringBuilderListSetMapLab {
	...
	public static void main(String[] args) {
		...
		System.out.println(switchFirstAndLast(fiveStrings));
		...
		System.out.println(searchStrings(fiveStrings, "a"));
		...
		for (int i = 0; i < 4; i++) {
			System.out.println(sortedFiftyNums.get(i));
		}
		...
		System.out.println(stringLengths(fiveStrings));
